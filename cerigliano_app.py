...
#app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///dna_verification.db' #Then I make the necessary SQL Alchemy configurations, I name the local sqlite database as dna_verification.db
